...
???????????????????????????????????????????????????????? `/api/exams/available` ?????????? `/api/exams/{paperId}/start` ??????? `/api/exams/{recordId}/submit` ??????????? `t_exam_record`??????? `t_exam_answer`?

### 9.2 ???????

????????????????????????????????????????????????????????????????????????????? `t_reservation`???????? `t_lab_time_slot`?

### 9.3 ???????

????????????????????????????????????? `t_report`??????? `t_report_score`?`is_latest` ?????????`grade_time` ?????????

### 9.4 ??? AI ?????

?????????????????AI ???AI ?????????????????? `t_recommend_record`?AI ?????? `t_ai_chat_record`?AI ????????/????????????????AI???????????????????????????????
