...
INSERT INTO `t_exam_answer` VALUES (1,1,1,NULL,'A',1,1,50),(2,1,2,NULL,'A,B,D',1,1,40);
...
INSERT INTO `t_exam_paper` (`id`, `title`, `description`, `course_id`, `experiment_id`, `total_score`, `pass_score`, `duration`, `attempt_limit`, `show_answer_after_submit`, `admission_validity_days`, `multiple_score_policy`, `random_enabled`, `random_count`, `teacher_id`, `status`, `start_time`, `end_time`, `create_time`, `update_time`, `is_deleted`) VALUES (1,'钻井液实验安全准入考试','完成后可进入实验预约。',1,1,100,70,30,3,1,90,'ALL_OR_NOTHING',0,0,3,'PUBLISHED','2026-07-03 12:04:06','2026-10-06 12:04:06','2026-07-08 12:04:06','2026-07-08 12:04:06',0);
...
INSERT INTO `t_exam_paper_question` VALUES (1,1,1,50,1),(2,1,2,50,2);
...
INSERT INTO `t_exam_record` VALUES (1,5,1,1,90,90,0,'GRADED','[{\"id\": 1, \"type\": \"SINGLE\", \"content\": \"钻井液密度测试时首先应确认什么？\", \"answer\": \"A\", \"score\": 50}, {\"id\": 2, \"type\": \"MULTIPLE\", \"content\": \"井控风险识别应关注哪些信号？\", \"answer\": \"A,B,D\", \"score\": 50}]',0,NULL,1,'2026-07-06 11:04:06','2026-07-06 12:04:06','2026-07-06 11:04:06','2026-07-06 12:04:06','2026-07-06 12:04:06','2026-07-08 12:04:06','2026-07-08 12:04:06',0),(2,5,1,1,NULL,NULL,NULL,'IN_PROGRESS','[{\"id\":1,\"type\":\"SINGLE\",\"content\":\"钻井液密度测试时首先应确认什么？\",\"options\":\"[{\\\"key\\\": \\\"A\\\", \\\"label\\\": \\\"密度计已校准\\\"}, {\\\"key\\\": \\\"B\\\", \\\"label\\\": \\\"随意取样\\\"}]\",\"answer\":\"A\",\"analysis\":\"密度计校准是读数可靠的前提。\",\"knowledgePoint\":\"密度计校准\",\"knowledgeId\":null,\"riskType\":\"飞溅\",\"difficulty\":\"EASY\",\"relatedResourceId\":1,\"score\":50,\"orderNum\":1},{\"id\":2,\"type\":\"MULTIPLE\",\"content\":\"井控风险识别应关注哪些信号？\",\"options\":\"[{\\\"key\\\": \\\"A\\\", \\\"label\\\": \\\"立压变化\\\"}, {\\\"key\\\": \\\"B\\\", \\\"label\\\": \\\"返出流量异常\\\"}, {\\\"key\\\": \\\"D\\\", \\\"label\\\": \\\"泥浆池液面变化\\\"}]\",\"answer\":\"A,B,D\",\"analysis\":\"压力、流量和液面变化是关键判断依据。\",\"knowledgePoint\":\"井控异常信号\",\"knowledgeId\":null,\"riskType\":\"高压\",\"difficulty\":\"MEDIUM\",\"relatedResourceId\":2,\"score\":50,\"orderNum\":2}]',0,NULL,NULL,'2026-07-09 10:32:51',NULL,'2026-07-09 11:02:51',NULL,NULL,'2026-07-09 10:32:50','2026-07-09 10:32:50',0);
...
INSERT INTO `t_experiment_admission` VALUES (1,5,1,1,1,'VALID','2026-07-06 12:04:06','2026-10-04 12:04:06',NULL,NULL,NULL,'2026-07-08 12:04:06','2026-07-08 12:04:06',0);
...
--
-- Table structure for table `t_hse_practice_answer`
--

DROP TABLE IF EXISTS `t_hse_practice_answer`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `t_hse_practice_answer` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `student_id` bigint NOT NULL,
  `question_id` bigint NOT NULL,
  `knowledge_id` bigint DEFAULT NULL,
...
--
-- Dumping data for table `t_hse_practice_answer`
--

LOCK TABLES `t_hse_practice_answer` WRITE;
/*!40000 ALTER TABLE `t_hse_practice_answer` DISABLE KEYS */;
/*!40000 ALTER TABLE `t_hse_practice_answer` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `t_hse_question_favorite`
--

DROP TABLE IF EXISTS `t_hse_question_favorite`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `t_hse_question_favorite` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `student_id` bigint NOT NULL,
  `question_id` bigint NOT NULL,
  `create_time` datetime DEFAULT CURRENT_TIMESTAMP,
...
--
-- Dumping data for table `t_hse_question_favorite`
--

LOCK TABLES `t_hse_question_favorite` WRITE;
/*!40000 ALTER TABLE `t_hse_question_favorite` DISABLE KEYS */;
/*!40000 ALTER TABLE `t_hse_question_favorite` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `t_hse_wrong_question`
--

DROP TABLE IF EXISTS `t_hse_wrong_question`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `t_hse_wrong_question` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `student_id` bigint NOT NULL,
  `question_id` bigint NOT NULL,
  `knowledge_id` bigint DEFAULT NULL,
...
--
-- Dumping data for table `t_hse_wrong_question`
--

LOCK TABLES `t_hse_wrong_question` WRITE;
/*!40000 ALTER TABLE `t_hse_wrong_question` DISABLE KEYS */;
/*!40000 ALTER TABLE `t_hse_wrong_question` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `t_learning_task` VALUES (1,1,1,'观看钻井液预习视频','RESOURCE',1,NULL,NULL,NULL,1,1,'2026-07-03 12:04:06','2026-07-28 12:04:06','AUTO',1,'2026-07-08 12:04:06','2026-07-08 12:04:06',0),(2,1,1,'提交钻井液实验报告','REPORT',NULL,NULL,NULL,NULL,1,2,'2026-07-03 12:04:06','2026-07-28 12:04:06','AUTO',1,'2026-07-08 12:04:06','2026-07-08 12:04:06',0),(3,2,3,'阅读管输压降指导书','RESOURCE',3,NULL,NULL,NULL,1,1,'2026-07-03 12:04:06','2026-07-28 12:04:06','AUTO',1,'2026-07-08 12:04:06','2026-07-08 12:04:06',0),(4,3,4,'学习HSE事故案例','RESOURCE',4,NULL,NULL,NULL,1,1,'2026-07-03 12:04:06','2026-07-28 12:04:06','AUTO',1,'2026-07-08 12:04:06','2026-07-08 12:04:06',0);
...
INSERT INTO `t_learning_task_record` VALUES (1,1,5,'COMPLETED','2026-07-05 12:04:06','2026-07-09 18:29:51','RESOURCE','2026-07-08 12:04:06','2026-07-08 12:04:06',0),(2,3,6,'IN_PROGRESS','2026-07-05 12:04:06',NULL,'DEMO','2026-07-08 12:04:06','2026-07-08 12:04:06',0),(3,4,7,'COMPLETED','2026-07-05 12:04:06','2026-07-07 12:04:06','DEMO','2026-07-08 12:04:06','2026-07-08 12:04:06',0);
...
INSERT INTO `t_role_permission` VALUES (1,1),(1,2),(1,3),(1,5),(1,6),(1,8),(1,9),(1,18),(1,20),(1,24),(1,28),(1,30),(1,31),(1,37),(1,40),(1,51),(1,55),(1,57),(5,1),(5,2),(5,3),(5,4),(5,5),(5,6),(5,7),(5,8),(5,9),(5,10),(5,11),(5,12),(5,13),(5,14),(5,15),(5,16),(5,17),(5,18),(5,19),(5,20),(5,21),(5,22),(5,23),(5,24),(5,25),(5,26),(5,27),(5,28),(5,29),(5,30),(5,31),(5,32),(5,33),(5,34),(5,35),(5,36),(5,37),(5,38),(5,39),(5,40),(5,41),(5,42),(5,43),(5,44),(5,45),(5,46),(5,47),(5,48),(5,49),(5,50),(5,51),(5,52),(5,53),(5,54),(5,55),(5,56);
/*!40000 ALTER TABLE `t_role_permission` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `t_safety_knowledge`
--

DROP TABLE IF EXISTS `t_safety_knowledge`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `t_safety_knowledge` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `experiment_id` bigint DEFAULT NULL,
  `category` varchar(50) NOT NULL DEFAULT 'HSE_BASIC',
  `knowledge_point` varchar(120) NOT NULL,
  `risk_type` varchar(50) DEFAULT NULL,
  `content` text NOT NULL,
  `related_step_id` bigint DEFAULT NULL,
  `reference_resource_id` bigint DEFAULT NULL,
  `emergency_flag` tinyint NOT NULL DEFAULT '0',
  `status` tinyint DEFAULT '1',
  `create_time` datetime DEFAULT CURRENT_TIMESTAMP,
  `update_time` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `deleted` tinyint DEFAULT '0',
...
--
-- Dumping data for table `t_safety_knowledge`
--

LOCK TABLES `t_safety_knowledge` WRITE;
/*!40000 ALTER TABLE `t_safety_knowledge` DISABLE KEYS */;
INSERT INTO `t_safety_knowledge` VALUES (1,1,'HSE_BASIC','密度计校准','飞溅','密度测试前应校准水平泡并排除气泡。',NULL,NULL,0,1,'2026-07-08 12:04:06','2026-07-08 12:04:06',0),(2,2,'HSE_BASIC','井控异常信号','高压','返出流量异常和立压变化是井控风险信号。',NULL,NULL,1,1,'2026-07-08 12:04:06','2026-07-08 12:04:06',0),(3,3,'HSE_BASIC','泵启动前检查','机械','启动泵前确认阀门开度和管路无泄漏。',NULL,NULL,0,1,'2026-07-08 12:04:06','2026-07-08 12:04:06',0),(4,4,'HSE_BASIC','事故链分析','HSE','从人、机、环、管四类因素复盘控制点。',NULL,NULL,1,1,'2026-07-08 12:04:06','2026-07-08 12:04:06',0);
/*!40000 ALTER TABLE `t_safety_knowledge` ENABLE KEYS */;
UNLOCK TABLES;
...
) ENGINE=InnoDB AUTO_INCREMENT=61 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='令牌表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `t_token` VALUES (60,1,'6e79542f48cd419fb926e97c8c9c2e8d','2026-07-10 19:24:32','2026-07-09 19:24:32');
...
-- Dump completed on 2026-07-09 19:33:55
